...
const EditSystemModal: React.FC<EditSystemModalProps> = ({
    ...
    const [associatedHardwareIds, setAssociatedHardwareIds] = useState('');
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        const idsArray = associatedHardwareIds.split(',').map(id => id.trim()).filter(id => id);
        ...
        >
            ...
            >
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-6">
                        <label htmlFor="associated-hw-ids-edit" className="block text-gray-300 font-medium mb-1">Associated Hardware IDs</label>
                        <textarea
                            id="associated-hw-ids-edit"
                            value={associatedHardwareIds}
                            onChange={(e) => setAssociatedHardwareIds(e.target.value)}
                        ...
                        />
                        <p className="text-xs text-gray-400 mt-1">Enter Hardware IDs separated by commas.</p>
                    </div>
