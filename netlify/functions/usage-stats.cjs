...
**Current Status:** ${usagePercent >= 100 ? '⛔ EXCEEDED' : '⚠️ WARNING'}

### Summary
- **Current Token Usage:** ${formatTokens(currentTokens)} tokens
- **Monthly Token Budget:** ${formatTokens(monthlyTokenBudget)} tokens
- **Usage:** ${usagePercent.toFixed(1)}%
- **Remaining:** ${formatTokens(monthlyTokenBudget - currentTokens)} tokens

### Recommended Actions
${usagePercent >= 100 ? `
1. ⛔ **Immediate:** Consider pausing non-essential AI operations
2. Review recent high-token operations in the Cost Dashboard
...
### Generated By
This issue was automatically created by the BMSview AI Cost Management system.
