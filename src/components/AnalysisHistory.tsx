                    ...
                    <table className="min-w-full text-sm divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Hardware ID</th>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            {!record.systemId ? (
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    <button
                                                        onClick={() => handleLinkRecord(record.id, record.hardwareSystemId || record.dlNumber)}
