...
const AdminHistoricalAnalysis: React.FC<AdminHistoricalAnalysisProps> = ({
  ...
  const handlePredictMaintenance = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        "/.netlify/functions/predictive-maintenance",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    <section>
      ...
      {analysisResult != null && (
        <div className="mb-6 p-4 bg-gray-800 rounded-lg shadow-inner">
          ...
          <pre className="text-sm text-gray-300 bg-gray-900 p-4 rounded">
      ...
      {analyticsData &&
        analyticsData.alertAnalysis &&
        analyticsData.alertAnalysis.totalEvents > 0 && (
          <div className="mb-6">
            <div className="bg-gray-800 p-4 rounded-lg shadow-inner">
              <div className="mb-4">
